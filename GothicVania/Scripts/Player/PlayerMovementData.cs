...
public class PlayerMovementData : MonoBehaviour
{
	...
	[Header("Assists")]
	[Space(10)]
	[Range(0.02f, 0.3f)] public float coyoteTime; //Grace period after falling off a platform, where you can still jump
    ...
    private void OnValidate()
    {
		...
		runAccelAmount = (20 * runAcceleration) / runMaxSpeed;
		runDeccelAmount = (20 * runDecceleration) / runMaxSpeed;
